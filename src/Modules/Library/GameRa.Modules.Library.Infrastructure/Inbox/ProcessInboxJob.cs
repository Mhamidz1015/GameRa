...
using GameRa.Common.Presentation;
...
namespace GameRa.Modules.Library.Infrastructure.Inbox;
...
{
    private const string ModuleName = "LibraryItem";
        ...
        IDbTransaction transaction)
    {
        string sql =
            $"""
             ...
             FROM libraryItem.inbox_messages
        ...
        Exception? exception)
    {
        const string sql =
            """
            UPDATE libraryItem.inbox_messages
