...
namespace GameRa.Modules.Users.Infrastructure.Migrations
{
    ...
    [Migration("20260715095740_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameRa.Modules.Users.Domain.Users.Permission", b =>
                {
            ...
            modelBuilder.Entity("GameRa.Modules.Users.Domain.Users.Role", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("GameRa.Modules.Users.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PermissionRole", b =>
                {
                    b.HasOne("GameRa.Modules.Users.Domain.Users.Permission", null)
                        .WithMany()
                    ...
                    b.HasOne("GameRa.Modules.Users.Domain.Users.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    ...
                    b.HasOne("GameRa.Modules.Users.Domain.Users.User", null)
                        .WithMany()
