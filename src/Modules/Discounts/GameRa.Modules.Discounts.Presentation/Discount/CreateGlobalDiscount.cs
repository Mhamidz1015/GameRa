...
internal sealed class CreateGlobalDiscount : IEndpoint
{
    public void MapEndpoint(IEndpointRouteBuilder app)
    {
        app.MapPost("discounts/global", async (Request request, ISender sender) =>
        {
            var command = new CreateGlobalDiscountCommand(
                request.Code,
                request.Type,
                request.Amount,
